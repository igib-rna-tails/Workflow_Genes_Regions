...
[The notebook](https://github.com/igib-rna-tails/Workflow_Genes_Regions/blob/master/PGT_Workflow_LL.ipynb) contains a procedure to prepare the sequencing data for visualization of the region plots. 
...
### You can find the instruction and the examples of plots in [PGT_Workflow_LL.ipynb](https://github.com/igib-rna-tails/Workflow_Genes_Regions/blob/master/PGT_Workflow_LL.ipynb)
